...
from .views import ( list_vehicles, create_vehicle, delete_vehicle, view_vehicle, update_vehicle,create_driver, delete_driver, list_drivers, update_driver, view_driver, assign_vehicle_to_driver, assign_driver_to_vehicle)
...
urlpatterns = [
    ...
    path('vehicle/<int:vehicle_id>/assign-driver/', assign_driver_to_vehicle, name='assign-driver-to-vehicle'),
    ...
    path('driver/assign/<int:driver_id>/', assign_vehicle_to_driver, name='assign-vehicle-to-driver'),
